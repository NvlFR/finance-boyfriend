...
class InvestmentPolicy
{
    ...
    {
        return $user->current_couple_space_id === $investment->couple_space_id;
    }
    ...
    {
        return $this->canManage($user, $investment);
    }
    ...
    private function canManage(User $user, Investment $investment): bool
    {
        return $user->current_couple_space_id === $investment->couple_space_id
            && ($investment->scope === 'shared' || $investment->user_id === $user->id);
    }
}
