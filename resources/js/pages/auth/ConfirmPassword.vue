...
<template>
    ...
    <div class="mx-auto max-w-md space-y-6 pt-4">
        <!-- Security Hero Card -->
        <div
            class="space-y-4 rounded-3xl border border-zinc-200/80 bg-white p-6 text-center shadow-sm dark:border-zinc-800 dark:bg-zinc-900"
        >
            <div
                class="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-amber-500/10 text-amber-600 dark:bg-amber-500/20 dark:text-amber-400"
            >
                <Lock class="h-7 w-7" />
            </div>
            ...
            <div>
                ...
                <p class="mt-1 text-xs leading-relaxed text-zinc-500">
                    Ini adalah area keamanan khusus akunmu. Mohon masukkan kata
            ...
            >
                ...
                <div class="pt-1">
                    <button
                        ...
                        class="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-indigo-600 to-rose-500 py-3 text-xs font-bold text-white shadow-md shadow-indigo-500/25 transition-all hover:opacity-95 disabled:opacity-50"
                    >
