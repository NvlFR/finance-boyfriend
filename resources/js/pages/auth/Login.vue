...
<template>
    ...
    <div
        v-if="status"
        class="mb-4 rounded-2xl border border-emerald-500/20 bg-emerald-500/10 p-3 text-center text-xs font-semibold text-emerald-600 dark:text-emerald-400"
    >
        {{ status }}
    </div>
    ...
    >
        ...
        <div class="flex items-center pt-1">
            <label
                class="flex cursor-pointer items-center gap-2 text-xs text-zinc-600 dark:text-zinc-400"
            >
                <input
                    id="remember"
                    name="remember"
        ...
        <div class="pt-2">
            <button
                ...
                class="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-indigo-600 to-rose-500 py-3 text-xs font-bold text-white shadow-lg shadow-indigo-500/25 transition-all hover:opacity-95 disabled:opacity-50"
            >
        ...
        <div class="relative my-3 flex items-center justify-center">
            ...
            <span
                class="absolute bg-white px-3 text-[10px] font-bold tracking-wider text-zinc-400 uppercase dark:bg-zinc-900"
                >atau</span
            >
        </div>
        ...
        <a
            href="/auth/google"
            class="flex w-full items-center justify-center gap-2.5 rounded-2xl border border-zinc-200 bg-white py-2.5 text-xs font-bold text-zinc-700 shadow-xs transition-colors hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200 dark:hover:bg-zinc-700"
        >
        ...
        <div class="pt-2 text-center text-xs text-zinc-500">
            ...
            <Link
                :href="register()"
                tabindex="6"
                class="ml-1 font-bold text-indigo-600 underline hover:text-indigo-500 dark:text-indigo-400"
            >
                Daftar Gratis
            </Link>
        </div>
