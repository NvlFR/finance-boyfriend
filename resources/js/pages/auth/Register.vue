    ...
    >
        ...
        <div class="pt-2">
            <button
                ...
                class="flex w-full items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-rose-500 to-indigo-600 py-3 text-xs font-bold text-white shadow-lg shadow-rose-500/25 hover:opacity-95 transition-all disabled:opacity-50"
            >
