...
import { KeyRound, Fingerprint } from '@lucide/vue';
...
<template>
    <div v-if="canManagePasskeys" class="space-y-4">
            ...
            <div class="flex items-center gap-2.5">
                ...
                <div>
                    ...
                    <p class="text-xs text-zinc-500">
                        Masuk lebih instan dan aman menggunakan Fingerprint,
        ...
        <div
            class="overflow-hidden rounded-2xl border border-zinc-200/80 bg-zinc-50/50 dark:border-zinc-800 dark:bg-zinc-900/50"
        >
            ...
            <div v-else class="p-6 text-center">
                <div
                    class="mx-auto mb-3 flex h-12 w-12 items-center justify-center rounded-2xl border border-zinc-200 bg-white shadow-sm dark:border-zinc-700 dark:bg-zinc-800"
                >
                ...
                <p class="mt-0.5 text-[11px] text-zinc-400">
                    Tambahkan Passkey agar dapat login otomatis tanpa perlu
                    mengetik kata sandi
                </p>
            </div>
        </div>
