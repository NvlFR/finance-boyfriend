...
const totalExpense = computed(() =>
    props.data.reduce((sum, d) => sum + d.expense, 0),
);
...
function toggleSelectedBar(index: number): void {
...
<template>
    ...
    >
        ...
        >
            ...
            <div class="flex items-center gap-2">
                <div
                    class="flex h-7 w-7 items-center justify-center rounded-lg bg-rose-500/10 text-rose-600 dark:text-rose-400"
                >
